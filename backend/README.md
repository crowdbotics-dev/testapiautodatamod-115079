...
## Project Structure
    ...
    ├── testapiautodatamod_115079  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_115079`
...
2. Clone this repo and `cd testapiautodatamod_115079`
